...
#if (THERMISTORHEATER_0 == 99) || (THERMISTORHEATER_1 == 99)  || (THERMISTORHEATER_2 == 99) || (THERMISTORBED == 99) //Smaller 100K bead thermistor

// Thermistor lookup table for RepRap Temperature Sensor Boards (http://make.rrrf.org/ts)
// Made with createTemperatureLookup.py (http://svn.reprap.org/trunk/reprap/firmware/Arduino/utilities/createTemperatureLookup.py)
// ./createTemperatureLookup.py --r0=100000 --t0=25 --r1=0 --r2=4700 --beta=3990 --max-adc=1023
// r0: 100000
// t0: 25
// r1: 0
// r2: 4700
...
const short temptable_99[][2] PROGMEM = {
   ...
   {61*OVERSAMPLENR,   254},
   {81*OVERSAMPLENR,   233},
   {101*OVERSAMPLENR,   218},
   {121*OVERSAMPLENR,   206},
   {141*OVERSAMPLENR,   196},
   {161*OVERSAMPLENR,   188},
   {181*OVERSAMPLENR,   180},
   {201*OVERSAMPLENR,   174},
   {221*OVERSAMPLENR,   168},
   {241*OVERSAMPLENR,   163},
   {261*OVERSAMPLENR,   158},
   {281*OVERSAMPLENR,   153},
   {301*OVERSAMPLENR,   149},
   {321*OVERSAMPLENR,   145},
   {341*OVERSAMPLENR,   141},
   {361*OVERSAMPLENR,   137},
   {381*OVERSAMPLENR,   133},
   {401*OVERSAMPLENR,   130},
   {421*OVERSAMPLENR,   127},
   {441*OVERSAMPLENR,   124},
   {461*OVERSAMPLENR,   120},
   {481*OVERSAMPLENR,   117},
   {501*OVERSAMPLENR,   114},
   {521*OVERSAMPLENR,   111},
   {541*OVERSAMPLENR,   109},
   {561*OVERSAMPLENR,   106},
   {581*OVERSAMPLENR,   103},
